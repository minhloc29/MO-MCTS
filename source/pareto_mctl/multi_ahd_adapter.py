from source.pareto_mctl.mcts_ahd import MCTS_AHD
from source.common.getParas import Paras
from source.common import prob_rank
from source.pareto_mctl.problem_adapter import Problem

from source.pareto_mctl import mo_pop_greedy
...
class AHD_Multi:
    ...
    def evolve(self):
        ...
        method = MCTS_AHD(self.paras, self.problem, prob_rank, mo_pop_greedy)
